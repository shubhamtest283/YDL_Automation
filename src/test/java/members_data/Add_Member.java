...
public class Add_Member {
	...
	public void mobilevalidation1() {
		br.driver.findElement(By.xpath("//input[@id='id_mobileNo']")).sendKeys("1fdfd55");
		submit();
	...
	@Test(priority = 5)
	public void mobilevalidation2() {
		br.driver.findElement(By.xpath("//input[@id='id_mobileNo']")).sendKeys("12345");
		submit();
		checkValidation(By.xpath("//input[@id='id_mobileNo']"), "Mobile number field accepting only numric value");
		br.driver.findElement(By.xpath("//input[@id='id_mobileNo']")).clear();
	}*/
